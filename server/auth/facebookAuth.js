...
const request_uri = 'https://www.facebook.com/v10.0/dialog/oauth?client_id='+keys.APP_ID+'&redirect_uri=http://localhost:8888/page&state='+STATE
var TOKEN = ""
...
prova1.get('/', (req, res) => {
    res.send('<a href="http://localhost:3000"><button>Accedi a Facebook</button></a>')
});
